...
<%
	...
	sql="select * from categories_0201366_6 where cname like '" & cname & "'"
	rs.open sql,conn 
	if (not rs.eof) then
		...
		'chèn vào CSDL
		sql = "insert into ccategories_0201366_6(cname,cdesc,cimage,corder, cstatus) values ('" & cname & "','" & cdesc & "','" & cimage & "'," & corder & "," & cstatus & ")"
		conn.execute sql 
