...
<%
    ...
    sql = "select * from 0209266_categories_57 where cname like '" & cname & "'"
    rs.open sql, conn 
    ...
    if (not rs.eof) then
        ...
        ' Chèn vào CSDL
        sql = "insert into 0209266_categories_57(cname, cimage, cdesc, corder, cstatus) values ('" & cname & "','" & cimage & "','" & cdesc & "'," & corder & "," & cstatus & ")"
        conn.execute sql 
