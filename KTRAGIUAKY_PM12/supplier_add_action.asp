...
sql = "select * from 0209266_supplier_57 where sname like '" & sname & "'"
rs.open sql, conn 
...
if (not rs.eof) then
    ...
    ' Chèn vào CSDL
    sql = "insert into 0209266_supplier_57(sname, saddress, sphone, stax, sstatus) values ('" & sname & "','" & saddress & "','" & sphone & "','" & stax & "'," & sstatus & ")"
    conn.execute sql 
